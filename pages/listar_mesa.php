...
<div class="panel-body">
  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
    ...
    <tr>
      <th class="ta">ID</th>
      <th class="ta">Numero da Mesa</th>
      <th class="ta">Status da Mesa</th>
    ...
    <tr class="odd gradeX">
      <td class="ta"><?php echo $res['id_mesa'];?></td>
      <td class="ta"><?php echo $res['numero_mesa'];?></td>
      <td class="ta"><?php echo $res['status_mesa'];?></td>
      <td>
